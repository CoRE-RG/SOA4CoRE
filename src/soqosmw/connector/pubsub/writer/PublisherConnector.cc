...
void PublisherConnector::setApplication(SOQoSMWApplicationBase* soqosMwApplicationBase) {
    _soqosMwApplicationBase = soqosMwApplicationBase;
}

SOQoSMWApplicationBase* PublisherConnector::getApplication() {
    return _soqosMwApplicationBase;
}
