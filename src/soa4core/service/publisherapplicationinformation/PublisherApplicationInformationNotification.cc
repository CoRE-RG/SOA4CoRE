...
PublisherApplicationInformationNotification::PublisherApplicationInformationNotification(PublisherApplicationInformation publisherApplicationInformation) :
...
PublisherApplicationInformation PublisherApplicationInformationNotification::getPublisherApplicationInformation() {
