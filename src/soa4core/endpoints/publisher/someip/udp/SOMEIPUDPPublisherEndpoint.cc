...
size_t SOMEIPUDPPublisherEndpoint::getHeaderBytes() {
    return UDPPublisherEndpoint::getHeaderBytes() + SOMEIP_HEADER_BYTES;
}
...
uint16_t SOMEIPUDPPublisherEndpoint::getServiceId() {
