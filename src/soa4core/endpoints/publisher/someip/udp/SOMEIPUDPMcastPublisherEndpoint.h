...
/**
 * @brief The SOMEIPUDPMcastPublisherEndpoint is a publisher endpoint module  SOME/IP traffic via UDP multicasts.
 ...
 */
class SOMEIPUDPMcastPublisherEndpoint : public SOMEIPPublisherEndpointBase, public UDPMcastPublisherEndpoint
{
/**
 * Methods
 */
...
#endif //__SOA4CORE_SOMEIPUDPMCASTPUBLISHERENDPOINT_H_
